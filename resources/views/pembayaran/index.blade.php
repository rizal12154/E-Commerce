            ...
            <div class="tf-page-cart-wrap layout-2">
                ...
                <div class="tf-page-cart-footer">
                    <div class="tf-cart-footer-inner">
                        ...
                        <form action="{{ route('pesanan.placeOrder') }}" method="POST"
                            class="tf-page-cart-checkout widget-wrap-checkout">
                            <ul class="wrap-checkout-product">
                                <li class="checkout-product-item">
                                    <figure class="img-product">
                                        <img src="{{ asset('') }}images/products/brown.jpg" alt="product">
                                ...
                                <li class="checkout-product-item">
                                    <figure class="img-product">
                                        <img src="{{ asset('') }}images/products/kid-12.jpg" alt="product">
                                        <span class="quantity">1</span>
                                    </figure>
                                    <div class="content">
                                        <div class="info">
                                ...
                                <li class="checkout-product-item">
                                    <figure class="img-product">
                                        <img src="{{ asset('') }}images/products/beige-2.jpg" alt="product">
                                        <span class="quantity">1</span>
                                    </figure>
                                    <div class="content">
                                        <div class="info">
                                ...
                                <li class="checkout-product-item">
                                    <figure class="img-product">
                                        <img src="{{ asset('') }}images/products/orange-1.jpg" alt="product">
                            ...
                            <button class="tf-btn radius-3 btn-fill btn-icon animate-hover-btn justify-content-center"
                                type="submit">Order Pesanan</button>
                        </form>
                    </div>
                </div>
            </div>
