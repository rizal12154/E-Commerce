                    ...
                    <form>
                        <table class="tf-table-page-cart">
                            ...
                            <tbody>
                                ...
                                @else
                                    @foreach ($keranjang as $get)
                                        @if (array_key_exists('produk_id', $get))
                                            <tr>
                                                <td>
                                                    <a href="/produk/{{ $get['produk_id'] }}">
                                                        <img src="{{ asset('storage/' . $get['gambar']) }}" alt="Produk"
                                                            width="80">
                                                    </a>
                                                    <div>{{ $get['nama'] }}</div>
                                                </td>
                                                ...
                                                <td>{{ $get['jumlah'] }}</td>
                                                <td>Rp. {{ number_format($get['harga'] * $get['jumlah'], 0, ',', '.') }}
                                                </td>
                                            </tr>
                                        @else
                                            <tr>
                                                <td colspan="4">Data produk tidak valid.</td>
                                            </tr>
                                        @endif
                                    @endforeach
