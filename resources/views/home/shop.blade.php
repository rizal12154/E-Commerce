                    ...
                    <div class="widget-facet wd-categories">
                        ...
                        <div id="categories" class="collapse show">
                            <ul class="list-categoris current-scrollbar mb_36">
                                ...
                                <li class="cate-item"><a href="#"><span>Smartphone</span>&nbsp;<span>(9)</span></a>
                                </li>
                                <li class="cate-item"><a href="#"><span>Headphone</span>&nbsp;<span>(23)</span></a>
                                </li>
                                <li class="cate-item"><a href="#"><span>Elektronik</span>&nbsp;<span>(20)</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="grid-layout wrapper-shop" data-grid="grid-3">
                        ...
                        <div class="card-product">
                                ...
                                @foreach ($produk as $get)
                                    ...
                                    <div class="list-product-btn absolute-2">
                                        <form action="{{ route('keranjang.store') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="produk_id" value="{{ $get->produk_id }}">
                                        ...
                                        <a href="/produk" class="box-icon bg_white quickview tf-btn-loading">
                            ...
                            <div class="card-product-info">
                                ...
                                <span class="price">Rp. {{ $get->harga }}</span>
                                @endforeach
                            </div>
                        </div>
                    </div>
