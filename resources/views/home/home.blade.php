                                ...
                                <div class="container">
                                    ...
                                    <ul class="submenu megamenu-container list-unstyled">
                                        <li class="menu-list-item nav-item-sub">
                                            <div class="mega-menu-header">
                                                <a class="nav-link-sub nav-text-sub megamenu-heading" href="/produk">
                                                    Category Pages
                                                </a>
                                                <span class="open-submenu">
                                            ...
                                            <div class="submenu-transform">
                                                ...
                                                <ul class="megamenu list-unstyled megamenu-container">
                                                    <li class="menu-list-item nav-item-sub">
                                                        <a class="nav-link-sub nav-text-sub" href="/produk">With Left
                                                            Sidebar</a>
                                                    </li>
                                                    <li class="menu-list-item nav-item-sub">
                                                    ...
                                                    <li class="menu-list-item nav-item-sub">
                                                        <a class="nav-link-sub nav-text-sub" href="/produk">3 Column
                                                            Layout</a>
                                                    </li>
                                                    <li class="menu-list-item nav-item-sub">
                                                        <a class="nav-link-sub nav-text-sub"
                ...
                <div class="minicart-loop custom-scrollbar">
                    ...
                    <div class="minicart-item d-flex">
                        <div class="mini-img-wrapper">
                            <img class="mini-img" src="{{ asset('') }}assets/img/products/furniture/1.jpg"
                                alt="img">
                        </div>
                            ...
                            <div class="misc d-flex align-items-end justify-content-between">
                                <div class="quantity d-flex align-items-center justify-content-between">
                                    <button class="qty-btn dec-qty"><img
                                            src="{{ asset('') }}assets/img/icon/minus.svg" alt="minus"></button>
                                    <input class="qty-input" type="number" name="qty" value="1"
                                        min="0">
                                    <button class="qty-btn inc-qty"><img src="{{ asset('') }}assets/img/icon/plus.svg"
                                            alt="plus"></button>
                                </div>
                    ...
                    <div class="minicart-item d-flex">
                        <div class="mini-img-wrapper">
                            <img class="mini-img" src="{{ asset('') }}assets/img/products/furniture/2.jpg"
                                alt="img">
                        </div>
                        <div class="product-info">
                            ...
                            <div class="misc d-flex align-items-end justify-content-between">
                                <div class="quantity d-flex align-items-center justify-content-between">
                                    ...
                                    <button class="qty-btn inc-qty"><img
                                            src="{{ asset('') }}assets/img/icon/plus.svg" alt="plus"></button>
                                </div>
                                <div class="product-remove-area d-flex flex-column align-items-end">
                                    <div class="product-price">$580.00</div>
                                    <a href="#" class="product-remove">Remove</a>
                    ...
                    <div class="minicart-item d-flex">
                        <div class="mini-img-wrapper">
                            <img class="mini-img" src="{{ asset('') }}assets/img/products/furniture/3.jpg"
                                alt="img">
                        </div>
                        <div class="product-info">
                    ...
                    <div class="minicart-item d-flex">
                        <div class="mini-img-wrapper">
                            <img class="mini-img" src="{{ asset('') }}assets/img/products/furniture/4.jpg"
                                alt="img">
                        </div>
                        <div class="product-info">
                            <h2 class="product-title"><a href="#">Vita Lounge Chair</a></h2>
                                ...
                                <div class="product-img-large">
                                    ...
                                    "asNavFor": ".qv-thumb-slider"
                                        ...
                                        <div class="img-large-wrapper">
                                            <img src="{{ asset('') }}assets/img/products/bags/39.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{ asset('') }}assets/img/products/bags/38.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{ asset('') }}assets/img/products/bags/37.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{ asset('') }}assets/img/products/bags/36.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{ asset('') }}assets/img/products/bags/34.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{ asset('') }}assets/img/products/bags/30.jpg" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{ asset('') }}assets/img/products/bags/32.jpg" alt="img">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    "asNavFor": ".qv-large-slider"
                                        ...
                                        <div>
                                            <div class="img-thumb-wrapper">
                                                <img src="{{ asset('') }}assets/img/products/bags/39.jpg"
                                                    alt="img">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="img-thumb-wrapper">
                                                <img src="{{ asset('') }}assets/img/products/bags/38.jpg"
                                                    alt="img">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="img-thumb-wrapper">
                                                <img src="{{ asset('') }}assets/img/products/bags/37.jpg"
                                                    alt="img">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="img-thumb-wrapper">
                                                <img src="{{ asset('') }}assets/img/products/bags/36.jpg"
                                                    alt="img">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="img-thumb-wrapper">
                                                <img src="{{ asset('') }}assets/img/products/bags/34.jpg"
                                                    alt="img">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="img-thumb-wrapper">
                                                <img src="{{ asset('') }}assets/img/products/bags/30.jpg"
                                                    alt="img">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="img-thumb-wrapper">
                                                <img src="{{ asset('') }}assets/img/products/bags/32.jpg"
                                                    alt="img">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="product-details ps-lg-4">
                                ...
                                <div class="misc d-flex align-items-end justify-content-between mt-4">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button class="qty-btn dec-qty"><img
                                                src="{{ asset('') }}assets/img/icon/minus.svg"
                                                alt="minus"></button>
                                        <input class="qty-input" type="number" name="qty" value="1"
                                            min="0">
                                        <button class="qty-btn inc-qty"><img
                                                src="{{ asset('') }}assets/img/icon/plus.svg"
                                                alt="plus"></button>
                                    </div>
            ...
            <div class="modal-content newsletter-modal-content">
                ...
                <div class="modal-body px-4">
                    <form action="#" class="newletter-modal-form common-form mx-auto">
                        ...
                        <p class="newsletter-modal-misc text_14 mt-4 text-center pb-4">You can change your email preference
                            any time by clicking "unsubscribe" in your email.</p>
                    </form>
                </div>
            </div>
        </div>
